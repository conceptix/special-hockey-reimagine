                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: CachedNetworkImage(
                                          ...
                                          fadeOutDuration:
                                              Duration(milliseconds: 500),
                                          imageUrl:
                                              'https://xbzcbzuswkoaftwhijvr.supabase.co/storage/v1/object/public/content/assets/temp/rick.jpeg?t=2023-11-20T13%3A32%3A48.454Z',
                                          width: 44.0,
                                          height: 44.0,
                                          fit: BoxFit.cover,
                                        ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed('adminClubDetails');
                                      },
                                      child: wrapWithModel(
                                        model: _model.adminNavItemModel1,
                                        updateCallback: () => setState(() {}),
                                        child: AdminNavItemWidget(
                                          title: 'Puck Rewards',
                                          icon: FaIcon(
                                    ...
                                    InkWell(
                                      ...
                                      child: wrapWithModel(
                                        model: _model.adminNavItemModel2,
                                        updateCallback: () => setState(() {}),
                                        child: AdminNavItemWidget(
                                          title: 'Settings',
                                          icon: Icon(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: wrapWithModel(
                                        model: _model.adminNavItemModel3,
                                        updateCallback: () => setState(() {}),
                                        child: AdminNavItemWidget(
                                          title: 'Clubs',
                                          icon: Icon(
