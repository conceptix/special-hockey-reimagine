...
import 'admin_club_details_model.dart';
export 'admin_club_details_model.dart';

class AdminClubDetailsWidget extends StatefulWidget {
  const AdminClubDetailsWidget({Key? key}) : super(key: key);

  @override
  _AdminClubDetailsWidgetState createState() => _AdminClubDetailsWidgetState();
}

class _AdminClubDetailsWidgetState extends State<AdminClubDetailsWidget> {
  late AdminClubDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminClubDetailsModel());
            ...
            Padding(
              ...
              child: StreamBuilder<List<ClubsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<ClubsRecord> dropDownClubsRecordList = snapshot.data!;
                  return FlutterFlowDropDown<String>(
                    controller: _model.dropDownValueController ??=
                        FormFieldController<String>(null),
                    options:
                        dropDownClubsRecordList.map((e) => e.city).toList(),
                    onChanged: (val) =>
